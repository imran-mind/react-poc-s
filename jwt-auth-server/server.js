...
// mysqlConnection.query('SELECT * from Persons', function (error, results, fields) {
//     if (error) throw error;
//     console.log('The solution is: ', results && results.length && results[0].solution);
// });
// dbQuery.insertUser({username:'imran',password: 'i', refreshToken: "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjEsImVtYWlsIjoiaW1yYW4iLCJpc3MiOiJibG9nZ2VyIiwiaWF0IjoxNTg4OTIwNzUwLCJleHAiOjE1ODg5MjA3NjB9.ZmEQCh_WzgyCGJmZk3HNQ2m2PU25GdMscMt8BAftlUs"}).then(results =>{
//     // console.log('-------> ',results)
// })
...
//      // will be storing into DB first
//     const refreshToken = auth.createRefreshToken(obj);
//     // For the sake of POC storing into HashMap
//     REFRESH_TOKENS.set('1', refreshToken);
//     res.cookie('refreshToken', refreshToken, cookieConfig);
//     res.status(200).json({token: jwtToken,  jwtExpiry: 60, firstName: 'imran',lastName: 'Shaikh',id:1})       
// });
